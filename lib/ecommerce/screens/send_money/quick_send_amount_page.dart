...
import '/ecommerce/screens/request_money/receive_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: Image.asset('assets/eco/icons/cut_qr.png'),
              onPressed: () {
                              ...
                              children: <Widget>[
                                Container(
                                  margin: const EdgeInsets.symmetric(
                                      horizontal: 8.0),
                                  child: Image.asset('assets/eco/icons/5 usd.png'),
                                ),
                                Container(
                                  margin: const EdgeInsets.symmetric(
                                      horizontal: 8.0),
                                  child: Image.asset('assets/eco/icons/10 usd.png'),
                                ),
                                Container(
                                  margin: const EdgeInsets.symmetric(
                                      horizontal: 8.0),
