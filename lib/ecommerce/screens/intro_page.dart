...
import '/ecommerce/screens/main/main_page.dart';
...
//      width: MediaQuery.of(context).size.width,
        decoration: BoxDecoration(
            ...
            image: DecorationImage(image: AssetImage('assets/eco/background.png'))),
        child: Stack(
          children: <Widget>[
            PageView(
              onPageChanged: (value) {
