...
import '/ecommerce/screens/address/add_address_page.dart';
import '/ecommerce/screens/payment/unpaid_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            icon: Image.asset('assets/eco/icons/denied_wallet.png'),
